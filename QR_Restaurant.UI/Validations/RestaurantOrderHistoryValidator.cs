...
{
    public class RestaurantOrderHistoryValidator : AbstractValidator<OrderHistoryViewModel>
    {
        private readonly ValidationLocalizer _localizer;
        public RestaurantOrderHistoryValidator(ValidationLocalizer localizer)
        {
